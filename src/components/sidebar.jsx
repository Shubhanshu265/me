        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              ...
              <h1 id="colorlib-logo"><a href="index.html">Shubhanshu Srivastava</a></h1>
              <span className="email"><i className="icon-mail"></i> shubh.265@gmail.com</span>
            </div>
            ...
            <nav id="colorlib-main-menu">
              <ul>
                <li><a href="https://www.linkedin.com/in/shubhanshu-srivastava/" target="_blank" rel="noopener noreferrer"><i className="icon-linkedin2" /></a></li>
                <li><a href="https://www.facebook.com/shubh.265" target="_blank" rel="noopener noreferrer"><i className="icon-facebook2" /></a></li>
